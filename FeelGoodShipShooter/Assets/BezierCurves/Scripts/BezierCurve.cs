...
public class BezierCurve : MonoBehaviour {
    ...
    /// <summary>
    /// 	- Gets the rotation at 't' percent along this curve
    /// </summary>
    /// <returns>
    /// 	- Returns the rotation at 't' percent
    /// </returns>
    /// <param name='t'>
    /// 	- Value between 0 and 1 representing the percent along the curve (0 = 0%, 1 = 100%)
    /// </param>
    ...
    {
        if (t <= 0) return points[0].rotation;
        else if (t >= 1) return points[points.Length - 1].rotation;
        ...
        return GetRotation(p1, p2, t / curvePercent);
    }
    ...
    /// <summary>
    ///     - Gets the rotation 't' percent along a curve
    /// </summary>
	/// <returns>
	/// 	- The rotation 't' percent along the curve
	/// </returns>
	/// <param name='p1'>
	/// 	- The bezier point at the beginning of the curve
	/// </param>
	...
	/// 	- Value between 0 and 1 representing the percent along the curve (0 = 0%, 1 = 100%)
	/// </param>
    public static Quaternion GetRotation(BezierPoint p1, BezierPoint p2, float t)
    {
        return Quaternion.Slerp(p1.rotation, p2.rotation, t);
    }
